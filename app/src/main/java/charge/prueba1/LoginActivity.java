...
//        });
//
//        Button mEmailSignInButton = (Button) findViewById(R.id.button3);
//        mEmailSignInButton.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent siguiente = new Intent(LoginActivity.this, Main3Activity.class);
//                startActivity(siguiente);
//            }
//        });
//
//        Button mEmailregistrer = (Button) findViewById(R.id.button4);
//        mEmailregistrer.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_log = (Button) findViewById(R.id.button3);
        Button mEmailregistrer = (Button) findViewById(R.id.button4);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                String edad = jsonResponse.getString("age");
                                String email = jsonResponse.getString("email");
                                String dni = jsonResponse.getString("dni");
                                int phone = jsonResponse.getInt("telefono");
